...
Server`);
client.user.setActivity(`${prefix}Logic `, {
    type: "PLAYING"
  });
    ...
    fetch(`https://api.shuruhatik.repl.co/azkar`)
      ...
      .then(body => {
        const embed = new Discord.MessageEmbed()
          .setThumbnail("https://cdn.discordapp.com/attachments/1003692523681747055/1004332614942990397/1cecde596843a64f615e72c178f2b9cd.png")
          .setColor("#2097c2")
